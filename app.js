...
const questions = [
    ...
    "Aapke group mein sabse zyada late reply kaun karta hai?",
    "Kaun bina soche samjhe ‘haan bhai pakka aunga’ bol deta hai… aur fir nahi aata?",
    "Sabse zyada ‘bhai paise nahi hai’ bolne wala kaun hai?",
    "Kaun sabse zyada phone charge hone ka wait karta rehta hai?",
    "Kiska screen time sabse dangerous level par hai?",
    "Sabse zyada reels dekh kar time waste kaun karta hai?",
    "Kaun ‘bas 5 min aur’ bol kar 2 ghante laga deta hai?",
    "Sabse zyada overthinking kaun karta hai?",
    "Group ka ‘Google baba’ kaun hai (har baat ka answer deta hai)?",
    "Sabse zyada apni tarif khud kaun karta hai?",
    "Kiska fashion sense sabse ajeeb hai?",
    "Sabse zyada ‘bhai kal se pakka start’ bolne wala kaun hai?",
    "Kaun sabse zyada bina wajah gussa ho jata hai?",
    "Group ka sabse bada sleeper kaun hai?",
    "Kaun sabse zyada selfies leta hai?",
    "Kiska phone sabse zyada tootne ke chances mein rehta hai?",
    "Kaun sabse zyada excuses banata hai?",
    "Sabse zyada ‘bhai main busy hoon’ bolne wala kaun hai?",
    "Kaun sabse zyada dusron ki baatein sun kar gossip karta hai?",
    "Kaun sabse zyada ‘crush’ change karta rehta hai?",
    "Kaun sabse zyada ‘meme material’ hai?",
    "Group ka sabse bada ‘timepass king’ kaun hai?",
    "Kaun sabse zyada khana share nahi karta?",
    "Kaun sabse zyada ‘last seen hide’ karke ghoomta hai?",
    "Kaun sabse zyada online rehta hai par reply nahi karta?",
    "Kaun sabse zyada ‘free advice’ deta rehta hai?",
    "Agar group ka koi reality show hota, sabse pehle kaun eliminate hota?",
    "Kaun sabse zyada ‘fake busy’ rehta hai?",
    "Kisko sabse zyada attention chahiye hoti hai?",
    "Kaun sabse zyada ‘single rehne ka bahana’ deta hai?",
    "Agar kisi ka phone check ho gaya, sabse zyada problem kisko hogi?",
    "Kaun sabse zyada ‘good boy/girl’ banne ka drama karta hai?",
    "Group mein sabse zyada ‘chapri energy’ kiske andar hai?"
];
